...
void SLIDING_DOOR_WITH_SENSORS_init__(SLIDING_DOOR_WITH_SENSORS *data__, BOOL retain) {
  __INIT_VAR(data__->X0,0,1)
  ...
  __INIT_VAR(data__->ZS,__BOOL_LITERAL(FALSE),retain)
...
// Code part
void SLIDING_DOOR_WITH_SENSORS_body__(SLIDING_DOOR_WITH_SENSORS *data__) {
  // Initialise TEMP variables

  __SET_VAR(data__->RS0.,S,,__GET_VAR(data__->X0,));
  __SET_VAR(data__->RS0.,R1,,__GET_VAR(data__->X2,));
  RS_body__(&data__->RS0);
  __SET_VAR(data__->,Y0,,__GET_VAR(data__->RS0.Q1,));
  __SET_VAR(data__->,_TMP_NOT19_OUT,,!(__GET_VAR(data__->X0,)));
  ...
  __SET_VAR(data__->TON0.,IN,,__GET_VAR(data__->_TMP_AND18_OUT,));
  __SET_VAR(data__->TON0.,PT,,__time_to_timespec(1, 0, 0, 2, 0, 0));
  TON_body__(&data__->TON0);
  __SET_VAR(data__->,ZS,,__GET_VAR(data__->TON0.Q,));
  __SET_VAR(data__->,_TMP_AND7_OUT,,AND__BOOL__BOOL(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (UINT)2,
    (BOOL)__GET_VAR(data__->_TMP_NOT19_OUT,),
    (BOOL)__GET_VAR(data__->ZS,)));
  __SET_VAR(data__->,_TMP_OR9_OUT,,OR__BOOL__BOOL(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (UINT)2,
    (BOOL)__GET_VAR(data__->X0,),
    (BOOL)__GET_VAR(data__->X1,)));
  __SET_VAR(data__->SR1.,S1,,__GET_VAR(data__->_TMP_AND7_OUT,));
  __SET_VAR(data__->SR1.,R,,__GET_VAR(data__->_TMP_OR9_OUT,));
  SR_body__(&data__->SR1);
  __SET_VAR(data__->,Y1,,__GET_VAR(data__->SR1.Q1,));

  goto __end;

__end:
  return;
} // SLIDING_DOOR_WITH_SENSORS_body__() 
